...
module.exports = function (input) {
  ...
  traverse(ast, {
    ...
    ExportDefaultDeclaration(path) {
      const node = path.node;
      if (['BooleanLiteral'].includes(node.declaration.type)) {
        ...
        path.insertAfter(template.ast(`exports.default = ${defaultName};`));
        ...
        throw new Error(`Not support declaration type:${specifiersType}`);
      }
    },
  });
